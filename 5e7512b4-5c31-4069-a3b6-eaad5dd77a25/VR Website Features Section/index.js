            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="p-3 mb-3 text-center">
                        <img src="" class="vr-features-card-image" />
                ...
                <div class="col-12 col-md-4">
                    <div class="p-3 mb-3 text-center">
                        ...
                        <p class="vr-features-card-description">
                            Virtual Reality (VR) can create an environment similar to or completely different from the real world.<span class="interaction">natural interaction</span>
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-4">
